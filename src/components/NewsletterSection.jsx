            ...
            >
              ...
              >
                <motion.input
                  ...
                  className="w-full sm:w-auto md:w-70 px-4 sm:px-6 py-3 sm:py-4 rounded-xl sm:rounded-l-xl sm:rounded-r-none focus:outline-none focus:ring-2 focus:ring-green-500 bg-white"
                />
                <motion.button 
